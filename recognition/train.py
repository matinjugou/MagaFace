"""
modify from https://github.com/ZhaoJ9014/face.evoLVe.PyTorch
"""
import torch
...
if __name__ == '__main__':
    ...
    dataset_train = datasets.ImageFolder(os.path.join(DATA_ROOT), train_transform)
